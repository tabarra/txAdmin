...
export default async function SettingsPage(ctx: AuthedCtx) {
    ...
    const renderData = {
        ...
        locales,
        global: cleanRenderData(txCore.configVault.getScopedStructure('global')),
        fxserver: cleanRenderData(txCore.configVault.getScopedStructure('fxRunner')),
        playerDatabase: cleanRenderData(txCore.configVault.getScopedStructure('playerDatabase')),
        monitor: cleanRenderData(txCore.configVault.getScopedStructure('monitor')),
        discord: cleanRenderData(txCore.configVault.getScopedStructure('discordBot')),
