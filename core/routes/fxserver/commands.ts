...
export default async function FXServerCommands(ctx: AuthedCtx) {
    ...
    if (action == 'profile_monitor') {
        ...
        fxRunner.sendCommand('profiler', ['view', savePath], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'success',
    ...
    //==============================================
        ...
        fxRunner.sendCommand('txaKickAll', [fullReason], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'success',
    ...
    //==============================================
        ...
        fxRunner.sendCommand('restart', [parameter], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
    ...
    //==============================================
        ...
        fxRunner.sendCommand('start', [parameter], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
    ...
    //==============================================
        ...
        fxRunner.sendCommand('ensure', [parameter], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
    ...
    //==============================================
        ...
        fxRunner.sendCommand('stop', [parameter], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
    ...
    //==============================================
        ...
        fxRunner.sendCommand('refresh', [], ctx.admin.name);
        return ctx.send<ApiToastResp>({
            type: 'warning',
