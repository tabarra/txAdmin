import { BookIcon, FolderGit2, FolderPenIcon, HistoryIcon, RefreshCcw } from "lucide-react";
...
export default function VersionControlHeader({repository, childAmount, updateAvailableAmount}: Props) {
    return (
        <div className="flex flex-row w-full bg-card md:rounded-xl border gap-4 p-4 justify-between">
            ...
            <div className="flex flex-row gap-4 items-center hover:bg-secondary/75 rounded-md p-2 cursor-pointer">
                ...
                <div className="flex flex-col">
                    ...
                    <h1 className="text-muted-foreground">Check for outdated resources</h1>
                </div>
            </div>
        </div>
    )
