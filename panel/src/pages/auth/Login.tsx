    ...
    >({
        ...
        onError: (error) => {
            if (error.message.startsWith('NetworkError')) {
                setErrorMessage('Network error. If you closed txAdmin, please restart and try it again.');
            } else {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <CardContent className="grid gap-4">
                <div>
                    <Link href="auth/cfxre/redirect">
                        <a className='cfxrebtn'>
                            <svg
            ...
            {displayMessage && (
                <div className="text-center text-red-500 border-t p-2">
                    {displayMessage}
                </div>
            )}
        </form>
