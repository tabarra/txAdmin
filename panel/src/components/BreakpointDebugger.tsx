export default function BreakpointDebugger() {
    return <div className="sticky bottom-4 w-full flex flex-row justify-center pointer-events-none select-none z-[9999]">
        <div className="p-4 flex flex-wrap flex-row gap-4 uppercase justify-center items-center bg-zinc-900/50 w-fit">
