    ...
    return <div className='relative'>
        ...
        <div className={cn(isConfigPending && 'opacity-0 pointer-events-none')}>
            ...
            <div className="space-y-1 select-none">
                ...
                <MenuNavLink href="/server/config-editor" disabled={!hasPerm('server.cfg.editor')}>
                    <FileEditIcon className="mr-2 h-4 w-4" />Config Editor
                </MenuNavLink>
                <MenuNavLink href="/server/cfg-editor" disabled={!hasPerm('server.cfg.editor')}>
                    <FileEditIcon className="mr-2 h-4 w-4" />CFG Editor {/* FIXME:NC */}
                </MenuNavLink>
